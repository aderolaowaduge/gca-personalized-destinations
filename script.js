...
function createCard(place) {
  ...
  // It should resemble the structure shown in the readme.
  // Interpolate the values for place.name, place.img, and place.location where needed. More info - https://wesbos.com/template-strings-html
  div.innerHTML = `
    <div class="col">
